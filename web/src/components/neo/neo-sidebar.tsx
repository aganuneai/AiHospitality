    ...
    return (
        <aside className={cn("pb-12 w-72 border-r border-border/50 bg-sidebar/80 backdrop-blur-xl h-screen sticky top-0 flex flex-col shadow-sm transition-all duration-300", className)} {...props}>
            <div className="space-y-6 py-6 h-full flex flex-col overflow-y-auto custom-scrollbar">
                ...
                <div className="mt-auto px-6 py-4 border-t border-border/40 mx-4 rounded-2xl bg-secondary/30 backdrop-blur-md flex flex-col gap-4">
                    ...
                    <button
                        ...
                        className="flex items-center gap-2 px-3 py-2 rounded-lg text-xs font-bold text-red-600 hover:bg-red-50 dark:hover:bg-red-950/30 transition-colors w-full border border-red-200/50 dark:border-red-900/30"
                    >
                        <LogOut size={14} />
                        Sair do Sistema
                    </button>
